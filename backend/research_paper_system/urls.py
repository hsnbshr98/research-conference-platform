"""
URL configuration for research_paper_system project.
...
from apps.researchers.views import ResearcherViewSet
from apps.conferences.views import ConferenceViewSet
